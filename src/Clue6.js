    ...
    render(){
        return(
            <div className="clue1-header">
                <h2>Go to the Brandenburg Gate</h2>
                ...
                <h2>Clue 6</h2>
                <h3 className="message">You are determined to find the last clue.
                    Great warriors guard the gate between East and West Berlin.
                    What weapon does the warrior facing in the direction of the Reichstag wield in her right hand?</h3>
